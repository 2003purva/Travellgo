...
>
  ...
  style={{ 
    display: 'grid', 
    //  Set to a 4-column grid for desktop to shrink individual card width
...
>
  {categories.map((item) => (
    <motion.div
      key={item.path}
      // Reduced height from 480px to 380px for a more compact look
    ...
    >
      <div className="relative w-full h-full rounded-[2rem] overflow-hidden shadow-md bg-white border-[4px] border-white transition-all duration-500 group-hover:shadow-xl">
        ...
        {/* Reduced padding from 10 to 6 for the text area */}
