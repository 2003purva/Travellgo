...
const PackageDetails = () => {
  ...
  const handlePackageBooking = async () => {
    ...
    // const priceNum = Number.parseFloat(plan.price.toString().replaceAll(",", ""));
          ...
          <aside className="booking-summary-card">
            ...
            <div className="booking-form">
              ...
              <div className="total-calculation">
                ...
                <strong>
                  ₹{(Number.parseFloat(plan.price.toString().replaceAll(",", "")) * bookingData.guests).toLocaleString("en-IN")}
                </strong>
              </div>
